---
title: The Pura project's officially complete!
date: 2026-01-14
---
...
So Pura, is this language I made up (what language isn't made up?) that currently compiles to JavaScript. I wrote the compiler in Haskell following Stephen Diehl's [Write You A Haskell](https://smunix.github.io/dev.stephendiehl.com/fun/) loosely, while also reading some other books on the topic (long names, just go check my report [here](/pura.pdf) if you'd like to know the entire list).

It's a cool little language, inspired by Haskell but now you don't have to worry about indentation (except I really need to get back to it and implement some basic pattern matching because writing a bunch of if-then-else expressions is getting old very fast). Elm was also a big inspiration (Pura literally compiles to JavaScript, follows Elm's [TEA](https://guide.elm-lang.org/architecture/) except because it is a solo project, it isn't optimized at all, and re-renders the entire DOM whenever there's a signal). The most important part to me, personally, is that I implemented the Hindley-Milner type inference system from basics and actually had... *fun* (after spending hours staring at buggy code where substitutions would not propagate, that is). Up next I'm thinking of maybe taking inspiration from [Koka's algebraic effects](https://koka-lang.github.io/koka/doc/book.html#why-effects).

::: { style="margin: 0 auto; text-align: center; align-items: center; display: flex; flex-direction: column;" }

<div class="tenor-gif-embed" data-postid="10721773101574343057" data-share-method="host" data-aspect-ratio="1.0122" data-width="40%"><a href="https://tenor.com/view/hollow-knight-hollow-knight-silksong-hk-hks-hkss-gif-10721773101574343057">Hollow Knight Hollow Knight Silksong GIF</a>from <a href="https://tenor.com/search/hollow+knight-gifs">Hollow Knight GIFs</a></div> <script type="text/javascript" async src="https://tenor.com/embed.js"></script>
